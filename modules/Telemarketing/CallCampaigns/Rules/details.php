...
$rules = ModuleManager::create_root()->init_module(Telemarketing_CallCampaigns_Rules::module_name());
if (isset($_POST['call_campaign']) && $_POST['call_campaign'] > 0) {
    $rules->mode = 'record';
    $rules->campaign = Utils_RecordBrowserCommon::get_record(Telemarketing_CallCampaigns_RBO_Campaigns::TABLE_NAME, $_POST['call_campaign']);
} else {
    $rules->mode = 'admin';
}
