...
class Telemarketing_Products_Premium_SalesOpportunityInstall extends ModuleInstall
{
    ...
    public function simple_setup()
    {
        if (ModuleManager::is_installed('Premium/SalesOpportunity') >= 0) {
            return array(
                ...
                'option' => __('Products') . ' - ' . __('Sales Opportunity')
            );
        }
        return array();
    }
    ...
    {
        return array(
            array('name' => Telemarketing_ProductsInstall::module_name(), 'version' => 0),
