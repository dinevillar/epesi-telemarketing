...
if (!$record['local_time']) {
    $timeZone = Telemarketing_ContactLocalTimeCommon::query_local_timezone($record, true, $type);
...
$record_local_time = Telemarketing_ContactLocalTimeCommon::local_time($record, $type, false, true);
