 ...
 * @Time: 3:56 PM
 *
 * @property Premium_Criteria_RBO_Rules rules_rbo
 */

defined("_VALID_ACCESS") || die('Direct access forbidden');;

class Premium_Criteria extends Module
{
    /**
     * @var Premium_Criteria_RBO_Rules $rules_rbo
     */
    public $rules_rbo = null;

    public function construct()
    {
        $this->rules_rbo = new Premium_Criteria_RBO_Rules();
    ...
    /**
     * @param $r Premium_Criteria_RBO_Rule
        ...
        if ($r['criteria']) {
            $gb_row->add_action(
                ...
                Base_ThemeCommon::get_template_file(
                    Premium_CriteriaInstall::module_name(),
                    'icon-small.png')
            );
        }
    }
