...
class Premium_Telemarketing_ProductsInstall extends ModuleInstall
{
    /**
    ...
    public function install()
    {
        ...
        if ($products_rbo->install()) {
            ...
            Utils_RecordBrowserCommon::enable_watchdog(
                ...
                array('Premium_Telemarketing_ProductsCommon', 'product_watchdog_label')
            );
            self::install_permissions();
            Utils_AttachmentCommon::new_addon(Premium_Telemarketing_Products_RBO_Products::TABLE_NAME);

            Utils_RecordBrowserCommon::register_processing_callback(
                Premium_Telemarketing_Products_RBO_Products::TABLE_NAME,
                array('Premium_Telemarketing_ProductsCommon', 'submit_products'));
    ...
    {
        $tab = Premium_Telemarketing_Products_RBO_Products::TABLE_NAME;
    ...
    public function uninstall()
    {
        ...
        if ($products_rbo->uninstall()) {
            ...
            Utils_AttachmentCommon::delete_addon(Premium_Telemarketing_Products_RBO_Products::TABLE_NAME);
    ...
    public function info()
    {
        return array(
            ...
            'Description' => "Telemarketing Products"
        );
    }
