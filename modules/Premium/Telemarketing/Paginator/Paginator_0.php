...
class Premium_Telemarketing_Paginator extends Module
{
    var $items_per_page;
    var $items_total;
    var $current_page;
    ...
    public function body($page = false, $ipp = false, $tpl = false)
    {
        ...
        if ($this->client) {
            load_js('modules/Premium/Telemarketing/Paginator/js/paginator.js');
    ...
    public function get_paginator_html($page = false, $ipp = false, $tpl = false)
    {
        ...
        $this->paginate($page, $ipp);
        if ($this->client) {
            load_js('modules/' . self::module_name() . '/js/paginator.js');
            $this->load_js_defaults();
        }
        if ($this->show_raw) {
            $this->display_pages();
