...
class Premium_Telemarketing_CallScriptsCommon extends ModuleCommon
{
    ...
    public static function menu()
    {
        return array(
            _M('Telemarketing') =>
                array('__submenu__' => 1, _M('Call Script Templates') => array('__weight__' => 0))
        );
    }
    ...
    {
        $paginator = $module->init_module(Premium_Telemarketing_Paginator::module_name());
    ...
    public static function get_paginator_html($module, $callscript, $client = 'CallScripts.paginate')
    {
        ...
        /**
         * @var Premium_Telemarketing_Paginator $paginator
         */
        $paginator = $module->init_module(Premium_Telemarketing_Paginator::module_name());
        $paginator->disable_all = true;
        $paginator->mid_range = 8;
    ...
    public static function get_callscript_page($callscript, $page = 0)
    {
        ...
        $page_table = Premium_Telemarketing_CallScripts_RBO_Templates::PAGES_TABLE_NAME;
        if (!$page || $page < 1) {
