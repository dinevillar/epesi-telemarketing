...
class Premium_Telemarketing_DialerCommon extends ModuleCommon
{
    public static function menu()
    {
        if (Base_AclCommon::check_permission('Dialer'))
            return array(
                _M('Telemarketing') =>
                    array('__submenu__' => 1, _M('Dialer') => array('__weight__' => 2))
            );
        return array();
    }
    ...
    {
        $settings = Premium_Telemarketing_CallCampaignsCommon::get_settings($campaign['id']);
        $record = array();
    ...
    private static function build_query($campaign, $type = false, $count = false, $callback = false)
    {
        ...
        $matchedRules = Premium_Telemarketing_CallCampaigns_RulesCommon::match_rules($campaign, 'Record', 'Remove:RecordFromQueue');
        ...
        if ($origType === 'crm_criteria' && $criteria) {
            $criteria_raw = Premium_CriteriaCommon::get_raw_crits($criteria, $criteria['recordset']);
    ...
    )
    {
        ...
        switch ($action[0]) {
            case 'Send':
                $mergeOpen = Premium_Telemarketing_MergeFieldsCommon::MERGE_OPEN_ID;
                $mergeClose = Premium_Telemarketing_MergeFieldsCommon::MERGE_CLOSE_ID;
                switch ($action[1]) {
                    case 'E-mail':
            ...
            case 'Add':
                switch ($action[1]) {
                    case 'Phonecall':
                        $defaults = array(
                            'subject' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
                            ...
                            'customer' => $customer,
                            'phone' => $phone,
                            'employees' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_multi_employees_merge(
                                $details['add_phonecall_employees']),
                            'description' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
                            ...
                            'date_and_time' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
                    ...
                    case 'Task':
                        $defaults = array(
                            'title' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
                            ...
                            'deadline' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
                            ...
                            'employees' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_multi_employees_merge($details['add_task_employees']),
                            'customers' => $customer,
                        );
                        $return = Base_BoxCommon::push_module('Utils/RecordBrowser', 'view_entry',
                            array(
                    ...
                    case 'Meeting':
                        $defaults = array(
                            ...
                            'time' => Base_RegionalSettingsCommon::reg2time(Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
                            ...
                            'date' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
                                    'choice' => $details['add_meeting_date_choice'],
                                    'specific_date_val' => isset($details['add_meeting_specific_date_val']) ?
                                        $details['add_meeting_specific_date_val'] : false,
                    ...
                    case 'SalesOpportunity':
                        ...
                        $defaults = array(
                            'opportunity_name' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
                            ...
                            'opportunity_manager' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_employee_merge($details['add_opp_manager']),
                            'type' => $details['add_opp_type'],
                            'probability____' => $details['add_opp_probability'],
                            'employees' => array(Premium_Telemarketing_CallCampaigns_RulesCommon::parse_employee_merge('current')),
                            ...
                            'start_date' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
                            ...
                            'follow_up_date' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_date_merge(
                                array(
            ...
            case 'AutoAdd':
                switch ($action[1]) {
                    case 'Phonecall':
                        $phonecall = array(
                            'subject' => substr(Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
                                $details['add_phonecall_subject'],
                                $campaign,
                                $record,
                                $record_type,
                            ...
                            'customer' => $customer,
                            'phone' => $phone,
                            'employees' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_multi_employees_merge($details['add_phonecall_employees']),
                            'description' => Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge
                            (
                                $details['add_phonecall_description'],
                                $campaign,
                    ...
                    case 'RecordNote':
                        $return = Utils_AttachmentCommon::add(
                            ...
                            0, Acl::get_user(),
                            Premium_Telemarketing_CallCampaigns_RulesCommon::parse_rule_merge(
