	...
	<tr>
		<td class="column" colspan="2">
			<table cellpadding="0" cellspacing="2" border="0" style="width:100%;"
				...
				<tr>
					<td class="label">
                        {$form_data.add_phonecall_date_choice.label}{if $form_data.add_phonecall_date_choice.required}*{/if}
					</td>
					<td style="box-shadow: inset 1px 1px 1px #777;border-radius: 0 4px 4px 0;">
						<table style="width:100%;">
							<tr>
								<td style="width:100px;" class="label">
                                    {$form_data.add_phonecall_date_choice.$index.current_date.html}
								</td>
								<td></td>
							</tr>
							<tr>
								<td class="label">
                                    {$form_data.add_phonecall_date_choice.$index.specific_date.html}
								</td>
								<td class="data">
                                    {$form_data.add_phonecall_specific_date_val.html}
								</td>
							</tr>
							<tr>
								<td class="label">
                                    {$form_data.add_phonecall_date_choice.$index.dynamic_date.html}
								</td>
								<td class="data">
									<table>
										<tbody>
										<tr>
											<td>{$form_data.add_phonecall_dynamic_date_num.html}</td>
											<td>{$form_data.add_phonecall_dynamic_date_denom.html}</td>
