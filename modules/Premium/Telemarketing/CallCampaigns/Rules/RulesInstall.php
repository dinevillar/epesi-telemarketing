...
class Premium_Telemarketing_CallCampaigns_RulesInstall extends ModuleInstall
{
    ...
    public function install()
    {
        ...
        Utils_RecordBrowserCommon::new_addon(
            ...
            'rules_addon',
            array(
                'Premium_Telemarketing_CallCampaigns_RulesCommon',
                'rules_addon_label'
            )
        );
        ...
        Utils_RecordBrowserCommon::register_processing_callback($campaign_tab, array(
            'Premium_Telemarketing_CallCampaigns_RulesCommon', 'submit_call_campaign'
        ));
    ...
    public function uninstall()
    {
        ...
        Utils_RecordBrowserCommon::unregister_processing_callback($campaign_tab, array(
            'Premium_Telemarketing_CallCampaigns_SettingsCommon', 'submit_call_campaign'
        ));
        return true;
    }
