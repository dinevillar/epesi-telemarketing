...
class Premium_Telemarketing_CallCampaigns_Reports extends Module
{
    ...
    public function show_report()
    {
        ...
        /* @var $reports_common Premium_Telemarketing_CallCampaigns_ReportsCommon */
        set_time_limit(0);
        $mode = $this->get_module_variable('report_mode', self::MODE_CALL_CAMPAIGNS);
        load_js('modules/' . self::module_name() . '/js/reports.js');
        $reports_common = Premium_Telemarketing_CallCampaigns_ReportsCommon::class;
        ...
        if ($mode == self::MODE_TELEMARKETER) {
            ...
            $rb_reports->set_reference_record_display_callback(array('Premium_Telemarketing_CallCampaignsCommon',
