...
if (IPHONE) {
    if (!isset($_GET['force_desktop'])) {
        ...
        Please choose <?php print(EPESI); ?> version:
        <ul>
...
<div id="body_content">
    ...
    <div id="epesiStatus">
        <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
            ...
            <tr>
                <td style="text-align: center; vertical-align: middle; height: 30px;"><span
                            id="epesiStatusText"><?php print(STARTING_MESSAGE); ?></span></td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align: middle; height: 30px;"><img src="images/loader.gif"
                                                                                           alt="loader" width="256"
